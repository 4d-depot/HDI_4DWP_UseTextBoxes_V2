...
Import and Export [4D Write Pro](https://us.4d.com/4D-write-pro) text boxes (4D v20) 

Find more information on the [blog post](https://blog.4d.com/4d-write-pro-text-boxes-docx-import-export-options/).
